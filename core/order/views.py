    ...
    def post(self, request):
        ...
        if user_id is not None:
            ...
            products = order.items.annotate(
                products_quantity=F('quantity'),
                sum_final_price=(F('price')-(F('price')*F('discount')/100)) * F('quantity'),
            ...
            order_detail = products.aggregate(
                total_price=Sum('sum_price'),
                total_final_price=Sum('sum_final_price'),
                total_discount_price=Sum('sum_discount_price'),
                total_count=Sum('products_quantity')
            ...
            order_data = {
                ...
                'total_final_price': order_detail['total_final_price'],
                'total_discount_price': order_detail['total_discount_price'],
                'total_count': order_detail['total_count'],
            }
