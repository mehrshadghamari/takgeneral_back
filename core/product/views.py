        ...
        if category_obj.parent is None:
            ...
            if category_obj.is_leaf_node():
                ...
                product_query = (
                    ...
                    .order_by("-special_offer", "-update_at")
                )
            ...
            brand_count_query = (
                Product.objects.filter(id__in=product_query.values("id"))
                .values("brand__id")
                .annotate(product_count=Count("brand"))
                .values("brand__id", "brand__name", "product_count")
            )
...
class ProductDetail(APIView):
    def get(self, request, id):
        ...
        product_serializer = productDetailSerializer(product_instance, context={"request": request})
